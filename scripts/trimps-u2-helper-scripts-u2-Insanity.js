...
var repeatMaps = setInterval(function() {
	if (shouldFightSomeMap()) {
		...
		if (game.global.world == 109 || game.global.world == 110 || game.global.world == 113 || game.global.world == 123) {
			mapMode = "p";
		}
...
var cookieOptimizerInterval = setInterval(function() {
	...
	if ((game.global.challengeActive + "") !== challengeToTry
		|| game.global.world < 93
		|| game.global.world > 98
		)
	return;
