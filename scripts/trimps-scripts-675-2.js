	...
	setTimeout(function() {
		...
		setTimeout(function() {
			...
			var createItemsMap = function() {
				...
				} else if (game.global.world == 662) {
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
					document.getElementById("biomeAdvMapsSelect").value = "Random";
					document.getElementById("lootAdvMapsRange").value = 0;
					if (game.resources.fragments.owned > 23.6e+60) {
						document.getElementById("lootAdvMapsRange").value = 9;
					}
		...
		trimpsIntervals.push(setInterval(function() {
			...
			trimpsIntervals.push(setInterval(function() {
				if (buyLastZoneEquipment) {
					...
					buyArm(autoEquipNumber);
				}
				if (!gogogo) {
					if (game.global.world % 100 == 0) {
						buyEquipment(autoEquipNumber + 50);
...
var initialAbandons = [525, 540, 554, 555, 564, 568, 585, 603, 615, 626, 636, 638, 645, 653, 662];
