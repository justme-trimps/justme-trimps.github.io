...
var plusZeroZones = [47, 77, 85, 91, 92, 93, 94, 95, 96, 97, 98, 104, 105, 106, 107, 108]
var plusOneZones = [/*54, 60, 61, 64, 80, 81, 82, 83, 84 /*, 90, 91, 92, 93, 94*//* 20% more dmg */];
var plusTwoZones = [79, 80, 83, 99, 100, 101, 102, 103];//[89, 90, 91, 92, 93];//61, 63/*69, 70*/];
...
var changeAutobuyingNumbersInterval = setInterval(function() {
	if (changeAutoBuy && !game.global.mapsActive) {
		...
		if (game.global.world >= 98) { autobuyingEquipmentNumber = 30; autobuyingArmNumber = 30; }
...
var hireFarmersInterval = setInterval(function() {
	...
	if (game.global.world < 90) {
		...
		if (game.global.world == 90 && game.global.lastClearedCell <= 88) {
			setMax(0.25, false);
			numTab(6);
			cancelTooltip();
			buyJob('Farmer');
