...
autobuyingEquipmentNumber = 3; autobuyingArmNumber = 3;
...
var saveTextForAutoLoad5 = '';
var saveTextForAutoLoadWorldCell5 = game.global.lastClearedCell;
var saveTextForAutoLoadMapCell5 = game.global.lastClearedMapCell;

if (autoLoadSaveInterval5) { clearInterval(autoLoadSaveInterval5); autoLoadSaveInterval5 = null; }
var autoLoadSaveInterval5 = setInterval(function() {
	if (game.global.world < 70)
		return;
	if (game.global.world > 100) {
		clearInterval(autoLoadSaveInterval5); 
		autoLoadSaveInterval5 = null;
		return;
	}
		
	if (!game.global.mapsActive) {
		saveTextForAutoLoad5 = null;
		return;
	}
		
	if (game.global.mapsOwnedArray[game.global.mapsOwnedArray.length - 1].level < game.global.world) {
		saveTextForAutoLoad5 = null;
		return;
	}
	
	if (document.getElementById('critSpan') && document.getElementById('critSpan').innerHTML.indexOf('red') > -1) {
		if (true /*saveTextForAutoLoadMapCell5 != game.global.lastClearedMapCell */) {
			console.log("autoLoadSaveInterval5 save");
			saveTextForAutoLoad5 = save(true);
			saveTextForAutoLoadWorldCell5 = game.global.lastClearedCell;
			saveTextForAutoLoadMapCell5 = game.global.lastClearedMapCell;
		}
	} 
	if (document.getElementById('critSpan') && document.getElementById('critSpan').innerHTML.indexOf('orange') > -1 && saveTextForAutoLoad5)
	{
		console.log("!! autoLoadSaveInterval5 load");
		load(saveTextForAutoLoad5);
	}
}, 15);
...
var autoLoadSaveInterval = setInterval(function() {
	if (game.global.world < 21 || !game.global.fighting)
		return;
	
	if (game.global.world > 100)
		clearInterval(autoLoadSaveInterval); autoLoadSaveInterval = null;
	
	if (getEnergyShieldState() >= 60) {
		...
		console.log("autoLoadSaveInterval load");
		load(saveTextForAutoLoad);
	}
}, 50);

var saveTextForAutoLoad2 = '';
var saveTextForAutoLoadWorldCell2 = game.global.lastClearedCell;
var saveTextForAutoLoadMapCell2 = game.global.lastClearedMapCell;


var saveTextForAutoLoad3 = '';
var saveTextForAutoLoadWorldCell3 = game.global.lastClearedCell;
var saveTextForAutoLoadMapCell3 = game.global.lastClearedMapCell;

if (autoLoadSaveInterval3) { clearInterval(autoLoadSaveInterval3); autoLoadSaveInterval3 = null; }
var autoLoadSaveInterval3 = setInterval(function() {
	if (game.global.world < 21)
		return;

	if (game.global.world > 100)
		clearInterval(autoLoadSaveInterval3); autoLoadSaveInterval3 = null;
	
	if (game.achievements.shielded.progress(6) && game.achievements.shielded.progress(6).indexOf('Still Earnable!') > -1) {
		console.log("autoLoadSaveInterval3 save");
		if ((game.global.lastClearedCell != saveTextForAutoLoadWorldCell3) || (saveTextForAutoLoadMapCell3 != game.global.lastClearedMapCell)) {
			saveTextForAutoLoad3 = save(true);
			saveTextForAutoLoadWorldCell3 = game.global.lastClearedCell;
			saveTextForAutoLoadMapCell3 = game.global.lastClearedMapCell;
		}
	} else {
		console.log("autoLoadSaveInterval3 load");
		load(saveTextForAutoLoad3);
	}
}, 7000);

var saveTextForAutoLoad4 = '';
var saveTextForAutoLoadWorldCell4 = game.global.lastClearedCell;
var saveTextForAutoLoadMapCell4 = game.global.lastClearedMapCell;

if (autoLoadSaveInterval4) { clearInterval(autoLoadSaveInterval4); autoLoadSaveInterval4 = null; }
var autoLoadSaveInterval4 = setInterval(function() {
	if (game.global.world < 21)
		return;
	
	if (game.global.world > 100)
		clearInterval(autoLoadSaveInterval4); autoLoadSaveInterval4 = null;
	
	if (game.achievements.shielded.progress(5) && game.achievements.shielded.progress(5).indexOf('Still Earnable!') > -1) {
		console.log("autoLoadSaveInterval4 save");
		if ((game.global.lastClearedCell != saveTextForAutoLoadWorldCell4) || (saveTextForAutoLoadMapCell4 != game.global.lastClearedMapCell)) {
			saveTextForAutoLoad4 = save(true);
			saveTextForAutoLoadWorldCell4 = game.global.lastClearedCell;
			saveTextForAutoLoadMapCell4 = game.global.lastClearedMapCell;
		}
	} else {
		console.log("autoLoadSaveInterval4 load");
		load(saveTextForAutoLoad4);
	}
}, 13000);


var energyShieldStateForAutocancel = 70;
var alwaysRunMinus = 0;
...
var autoCancelInterval = setInterval(function() {
	if (autoCancelActive) {
		if (getEnergyShieldState() < energyShieldStateForAutocancel && game.global.world > 21) {
			...
			if (alwaysRunMinus)
				mapToRun = game.global.world - alwaysRunMinus;
			...
			if (tryPlusOne && mapToRun == game.global.world)
				document.getElementById("advExtraLevelSelect").value = "1";
