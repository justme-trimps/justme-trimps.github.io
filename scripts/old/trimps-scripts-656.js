	...
	setTimeout(function() {
		...
		setTimeout(function() {
			...
			var createItemsMap = function() {
				...
				if (game.global.world == 500) {
				...
				} else if (game.global.world == 596) {
					document.getElementById("advExtraLevelSelect").value = "6";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 600) {
					document.getElementById("advExtraLevelSelect").value = "5";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 603) {
					document.getElementById("advSpecialSelect").value = "lmc";
					...
					document.getElementById("advExtraLevelSelect").value = "4";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 643) {
					document.getElementById("lootAdvMapsRange").value = 0;
					document.getElementById("advExtraLevelSelect").value = "9";
					document.getElementById("biomeAdvMapsSelect").value = "Random";
					document.getElementById("advSpecialSelect").value = "p";
					if (game.resources.fragments.owned > 1.75e+59) {
						document.getElementById("lootAdvMapsRange").value = 9;
					}
			...
			var itemsAction = function() {
				...
				if (findZoneNumber() == 620 && game.global.lastClearedCell > 93) {
					actionNeeded = true;
				}
				
				if (findZoneNumber() == 625 && game.global.lastClearedCell > 90) {
					actionNeeded = true;
				}
				
				if (findZoneNumber() == 635 && game.global.lastClearedCell > 90) {
					actionNeeded = true;
				}
				
				if (findZoneNumber() == 640 && game.global.lastClearedCell > 90) {
					actionNeeded = true;
				}
				
				if (findZoneNumber() == 650 && game.global.lastClearedCell > 90) {
					actionNeeded = true;
				}
				
				if (findZoneNumber() == 655 && game.global.lastClearedCell > 90) {
					actionNeeded = true;
				}
...
var initialAbandons = [525, 540, 554, 555, 564, 568, 585, 603, 615, 626, 636, 638, 643, 645, 652, 653, 654, 655, 656];
var abandons = initialAbandons.slice();
var noActionZones = [570, 571, 572, 573, 574, 577, 578, 579, 580, 581, 582, 583, 584, 586, 587, 588, 589, 592, 593, 594, 595, 596, 597, 598, 601, 602, 603, 604, 607, 608, 609, 612, 613, 614, 616, 617, 618, 619, 622, 623, 624, 639, 640, 641];
for (var iii = 0; iii < 599; iii++) { if (iii != 585) noActionZones.push(iii); }
var repeatForAnyZones = [652, 654, 655];
...
forcedPortalZone = 661;
actionZones = 71;
initialRestartZone = 656;
restartOnZone = 656;
...
var windFormationZones = "|616|617|618|619|620|631|632|633|634|635|646|647|648|649|650|661|662|663|664|665|676|677|678|679|680|";
