		...
		setTimeout(function() {
			...
			var createItemsMap = function() {
				if (!voidMapsFinished 
					...
					&& game.global.lastClearedCell > 78
					&& !abandonForced 
...
var logFluffyExpInterval = setInterval(function() {
	...
	if (lastFluffyExpLog < game.global.world) {
		...
		console.log(getPortalTime() + " " + game.global.world + " zone, fluffy exp rate: " + getFluffyExperienceRate() + " exp / s. HPH " + getHeliumPerHour());
	}
}, 3000);
...
var initialAbandons = [525, 540, 554, 555, 564, 568, 585, 603, 615, 626, 636, 638];
var abandons = initialAbandons.slice();
var noActionZones = [570, 571, 572, 573, 574, 577, 578, 579, 580, 581, 582, 583, 584, 585, 586, 587, 588, 589, 592, 593, 594, 595, 596, 597, 598, 601, 602, 603, 604, 607, 608, 609, 610, 611, 612, 613, 614, 616, 617, 618, 619, 622, 623, 624, 639, 641, 642, 643];
...
forcedPortalZone = 652;
actionZones = 60;
initialRestartZone = 645;
restartOnZone = 645;
