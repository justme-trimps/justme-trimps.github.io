...
var fightWorldInterval;

var shouldLoadFightWorldSave = function(save) {
...
var shouldSaveFightWorldSave = function(save) {
	if (game.global.mapsActive || !game.global.fighting)
		return false;
...
fightWorldInterval = setSomeInterval(fightWorldInterval, shouldSaveFightWorldSave, shouldLoadFightWorldSave, 1000);
