	...
	setTimeout(function() {
		...
		setTimeout(function() {
			...
			var createItemsMap = function() {
				...
				if (game.global.world == bwStartZone && game.global.lastClearedCell > 85) {
					startBw();
					return;
				}
				...
				} else if (game.global.world == 681) {
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
					document.getElementById("biomeAdvMapsSelect").value = "Random";
				} else if (game.global.world == 682) {
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
					document.getElementById("biomeAdvMapsSelect").value = "Random";
				} else if (game.global.world == 686) {
					document.getElementById("advExtraLevelSelect").value = "9";
					document.getElementById("advSpecialSelect").value = "p";
					document.getElementById("biomeAdvMapsSelect").value = "Random";
				} else if (game.global.world == 691) {
					document.getElementById("advSpecialSelect").value = "lmc";
				} else if (game.global.world == 696) {
					document.getElementById("advSpecialSelect").value = "lmc";
				} else if (game.global.world == 701) {
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
					document.getElementById("biomeAdvMapsSelect").value = "Random";
			...
			var itemsAction = function() {
				...
				if (findZoneNumber() == 680 && game.global.lastClearedCell > 85) {
					actionNeeded = true;
				}
	...
	var exitSpire = function() {
		if (exitSpireAutomatically && game.global.world == 700 && game.global.spireActive && game.global.lastClearedCell > exitSpireAutomaticallyCells) {
			endSpire();
		}
	}
...
var exitSpireAutomaticallyCells = 48;//20
var exitSpireAutomatically = true;
var lastMap = 0;
...
var repeatForAnyZones = [645, 675, 700]; // [500, 540, 554, 600];
...
forcedPortalZone = 712;
initialRestartZone = 705;
restartOnZone = 705;
...
var windFormationZones = "|541|542|543|544|545|556|557|558|559|560|571|572|573|574|575|586|587|588|589|590|601|602|603|604|605|616|617|618|619|620|631|632|633|634|635|646|647|648|649|650|661|662|663|664|665|676|677|678|679|680|691|692|693|694|695|706|707|708|709|710|"
...
var bwStartZone = 690;
var bwStopMap = "Bionic Wonderland XLI";
