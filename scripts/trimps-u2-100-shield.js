...
var autoLoadSaveInterval5 = setInterval(function() {
	...
	if (game.global.mapsOwnedArray[game.global.mapsOwnedArray.length - 1].level < game.global.world && game.global.mapsActive) {
		saveTextForAutoLoad5 = null;
		return;
	}
...
var energyShieldStateForAutocancel = 75;
...
var autoCancelInterval = setInterval(function() {
	if (autoCancelActive) {
		if (game.global.world < 65) return;
