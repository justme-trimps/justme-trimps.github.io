	...
	setTimeout(function() {
		...
		setTimeout(function() {
			...
			trimpsIntervals.push(setInterval(function() {
				...
				if (game.global.world == 795 
					&& document.getElementById('worldNumber')
					&& document.getElementById('worldNumber').innerText.indexOf('830') > -1) {
						var climbButton = document.getElementById('toggleclimbBw2');
						if (climbButton.getAttribute("class").indexOf("settingBtn1") > -1) {
							toggleSetting('climbBw');
						}
			...
			var createItemsMap = function() {
				...
				if (game.global.world == 585) {
					...
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 741) {
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 746) {
					document.getElementById("advExtraLevelSelect").value = "9";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 751) {
					document.getElementById("advExtraLevelSelect").value = "10";
					document.getElementById("advSpecialSelect").value = "p";
				} else if (game.global.world == 756) {
					document.getElementById("advExtraLevelSelect").value = "9";
					document.getElementById("advSpecialSelect").value = "p";
		...
		trimpsIntervals.push(setInterval(function() {
			...
			trimpsIntervals.push(setInterval(function() {
				if (buyLastZoneEquipment && game.global.world == 800) {
...
var noActionZones = [639, 641, 642, 643, 732, 733, 734, 735]; 
