...
var minMeltingZone = 97;
var autoCancelActive = false;
var smithiesWanted = 17;
var tributesWanted = 1200;
var autoHireFarmers = true;

var forcedPortalWorld = 110;

var plusZeroZones = [85, 86, 91, 92, 93, 94, 95, 97, 99, 104, 105, 106, 107, 108]
var plusOneZones = [47, 77];
var plusTwoZones = [80, 79, 100, 101, 102, 103];
var plusThreeZones = [55, 88, 98];
var plusFourZones = [];
var plusFiveZones = [45];
var plusSixZones = [];
var prestigiousZones = [78, 88, 98, 103];
...
var changeAutobuyingNumbersInterval = setInterval(function() {
	if (changeAutoBuy && !game.global.mapsActive) {
		...
		if (game.global.world >= 105) { autobuyingEquipmentNumber = 30; autobuyingArmNumber = 30; }
		if (game.global.world >= 106) { autobuyingEquipmentNumber = 50; autobuyingArmNumber = 50; }
	}
}, 1000 * 1);
