...
var initialAbandons = [525, 540, 554, 555, 564, 568, 585];
var abandons = initialAbandons.slice();
var noActionZones = [498, 499, 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511, 512, 513, 514, 515, 516, 517, 518, 519, 520, 521, 522, 523, 524, 525, 526, 527, 528, 529, 530, 531, 532, 533, 534, 535, 536, 537, 538, 540, 541, 542, 543, 544, 547, 548, 549, 550, 551, 552, 553, 554, 556, 557, 558, 559, 560, 561, 562, 563, 565, 566, 567, 569, 570, 571, 572, 573, 574, 577, 578, 579, 581, 582, 583, 584, 586, 587, 588, 589, 592, 593, 594, 595, 596, 597, 598];
var repeatForAnyZones = [500, 540, 554];
var autoNurseryInterval = 25000;
var forcedPortalZone = 600;//547 + 15 + 15;
var actionZones = 41 + 15;
var fastFight = true;
var fastFightZones = 507;
...
forcedPortalZone = 606;
actionZones = 41 + 15 + 15;
initialRestartZone = 600;
restartOnZone = 600;
nurseryZones = 2;
gaSecsZones = 1;
